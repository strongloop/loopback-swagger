...
function getModelNameForTag(tag) {
  return _.upperFirst(escapeIdentifier(tag));
}
...
exports.escapePropertyOrMethodName = escapePropertyOrMethodName;
...
BaseGenerator.prototype.mapTagsToModels = function(spec, options) {
  ...
  function mapTag(tag) {
    var modelName = getModelNameForTag(tag);
